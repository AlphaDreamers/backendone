...
type ChatRoom struct {
	ChatRoomID     uuid.UUID `gorm:"column:chat_room_id;type:uuid;primaryKey;default:gen_random_uuid()" json:"chat_room_id"`
	ParticipantOne uuid.UUID `gorm:"column:participant_one;type:uuid;not null" json:"participant_one"`
	ParticipantTwo uuid.UUID `gorm:"column:participant_two;type:uuid;not null" json:"participant_two"`
	MasterKey      string    `gorm:"column:master_key;type:text;not null;index:master_key_index" json:"master_key"`
	CreatedAt      time.Time `gorm:"column:created_at;autoCreateTime" json:"created_at"`
	ServiceId      uuid.UUID `gorm:"column:service_id;type:uuid;not null" json:"service_id"`
